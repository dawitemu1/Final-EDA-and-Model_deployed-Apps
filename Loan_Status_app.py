...
st.markdown(
    ...
    3. Credit scoring (probability prediction) using Explainable AI to limit the Risk grade.
    4. Based on the credit scoring (probability of prediction), each class may limit the collateral.
...
if st.sidebar.button("Loan_Status"):
    ...
    st.write(f"Loan Status: {LOAN_STATUS[prediction[0]]}")
